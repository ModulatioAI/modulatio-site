---
title: Tool catalog
description: Every tool the engine exposes to LLM skills — http_get, run_shell, write_artifact, read_tool_result. Schemas, profile contracts, sandbox interaction.
---

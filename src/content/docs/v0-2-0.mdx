...
v0.2.0 changes engine *behavior*, not its *ceilings*. The honest limits on the [Beta calibration page](/v0-1-0-beta/) — single-deliverable sweet spot, the six-task sub-objective cap, production-scale phasing — still hold. Read that page before serious work; this one is the *delta*.
</Aside>

...
v0.9.9.4 is the current Beta release — **stability + housekeeping**: a line-by-line audit of the shipped source hardened the engine's failure paths and cleaned the codebase for the run up to 1.0.

...
v1.0.2 is the current Beta release — the 1.0 line, and **still beta software**: the standalone Leader harness made bounded, observable, and unable to claim a success it did not earn. There is no stable release and this version number does not imply one.
...
## Current — v1.0.2 (the 1.0 line — still beta software)

The current release is **v1.0.2** ([release notes](/v1-0-2/)) — a patch over v1.0.0 — the 1.0 line, and

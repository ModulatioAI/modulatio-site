...
v0.2.2 adds a capability and closes a bug; it does not move the engine's ceilings. The honest limits on the [v0.1.0 Beta calibration page](/v0-1-0-beta/) still hold. This page is the *delta* on top of [v0.2.1](/v0-2-1/).
</Aside>

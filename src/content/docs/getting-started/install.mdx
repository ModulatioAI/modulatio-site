...
`modulatio-api` (a planned FastAPI server for a future web dashboard) is not installed in v0.1.0. The console script is intentionally not declared until the underlying module ships — see the [Roadmap](/roadmap/) for the long-horizon dashboard work.

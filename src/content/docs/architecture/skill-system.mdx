...
Modulatio's skill system is the answer to a simple question: how do you compose **what** a team can do without locking the team into fixed roles? v0.1.0 ships seventeen seed skills covering the multi-piece deliverable shape end-to-end.
...
v0.1.0 ships seventeen seed skills under `src/modulatio/_seed_skills/`:
...
| `consolidation.md` | Producer | Assemble N units into one deliverable. |

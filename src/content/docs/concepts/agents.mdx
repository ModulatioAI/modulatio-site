...
| **QC** | **Smart agentic / non-reasoning** (e.g. Kimi-class) | QC verifies by *running* things (tools) and — with QC-as-fixer — patches artifacts. The moment it acts/produces, the producer rule applies. Strong enough to judge, agentic enough to run tools without drift. |
...
QC reviews every artifact before it ships. The quality gate is first-class.

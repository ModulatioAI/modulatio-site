...
**[v0.2.0 release notes](/v0-2-0/)** — what's new in this release: the QC-thesis arc, the Product Quality Report, default standards, and the context-budget hardening.

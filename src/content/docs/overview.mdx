...
**[v0.2.1 release notes](/v0-2-1/)** — what's new in the current release: in-place editing (`--attach`), surgical patch mode, the code read-toolkit, and the delivery / verify-goal fixes.

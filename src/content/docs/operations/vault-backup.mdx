...
If the restore is to a host with different OS users, you may need to re-set permissions on `<vault>/` (v0.1.0 hardens some files to `0o600` — see [Multi-user hardening](/operations/multi-user-hardening/)).

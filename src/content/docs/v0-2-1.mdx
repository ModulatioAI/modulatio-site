...
v0.2.1 adds a capability; it does not move the engine's ceilings. The honest limits on the [Beta calibration page](/v0-1-0-beta/) — single-deliverable sweet spot, the six-task sub-objective cap, production-scale phasing — still hold. Read that page before serious work; this one is the *delta* on top of [v0.2.0](/v0-2-0/).
</Aside>
